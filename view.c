...
void CalcGunAngle (void)
{
	...
	//readd this
	cl.viewent2.angles[ROLL] = cl.viewent.angles[ROLL] -= v_idlescale.value * sin((int)(cl.time*v_iroll_cycle.value * 2)) * v_iroll_level.value;
	cl.viewent2.angles[PITCH] = cl.viewent.angles[PITCH] -= v_idlescale.value * sin((int)(cl.time*v_ipitch_cycle.value * 2)) * v_ipitch_level.value;
	cl.viewent2.angles[YAW] = cl.viewent.angles[YAW] -= v_idlescale.value * sin((int)(cl.time*v_iyaw_cycle.value * 2)) * v_iyaw_level.value;
